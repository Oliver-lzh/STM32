#ifndef VENDOR_PROTOCOL_REQUESTS_H_
#define VENDOR_PROTOCOL_REQUESTS_H_ 1
...
#define sizeof_RequestHeader() \
    (sizeof(((VendorProtocol_RequestHeader *)0)->bmReqType) + sizeof(((VendorProtocol_RequestHeader *)0)->bRequest) + sizeof(((VendorProtocol_RequestHeader *)0)->wValue) + sizeof(((VendorProtocol_RequestHeader *)0)->wIndex) + sizeof(((VendorProtocol_RequestHeader *)0)->wLength))

#define sizeof_ResponseHeader() \
    (sizeof(((VendorProtocol_ResponseHeader *)0)->bmReqType) + sizeof(((VendorProtocol_ResponseHeader *)0)->bStatus) + sizeof(((VendorProtocol_ResponseHeader *)0)->wLength))
...
#endif /* VENDOR_PROTOCOL_REQUESTS_H_ */
