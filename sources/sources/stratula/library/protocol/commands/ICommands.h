...
struct _ICommands
{
    uint16_t m_type; /* Type and Implementation of the component or module */

    uint8_t m_count; /* Number of currently registered instances */
     ...
     */
    uint8_t (*write)(uint8_t bId, uint8_t bSubinterface, uint8_t bFunction, uint16_t wLength, const uint8_t *payload);
     ...
     */
    uint8_t (*read)(uint8_t bId, uint8_t bSubinterface, uint8_t bFunction, uint16_t wLength, uint8_t **payload);
     ...
     *  	- bStatus returned by the read function associated with the parameters
     */
    uint8_t (*transfer)(uint8_t bId, uint8_t bSubinterface, uint8_t bFunction, uint16_t wLenghtIn, const uint8_t *payloadIn, uint16_t *wLengthOut, uint8_t **payloadOut);
};
