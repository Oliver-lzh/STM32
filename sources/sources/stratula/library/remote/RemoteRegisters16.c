...
{
    const uint16_t wValue = CMD_W_VALUE(self->m_type);
...
void RemoteRegisters16_Constructor(RemoteRegisters16 *self, IVendorCommands *vendorCommands, uint16_t type, uint8_t id)
{
