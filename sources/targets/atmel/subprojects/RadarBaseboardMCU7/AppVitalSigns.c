...
#if ((APP_VITAL_SIGNS_ENABLE_FRAME_OUTPUT != 0u) || (APP_VITAL_SIGNS_ENABLE_DETAILED_OUTPUT != 0u))
...
static void print_latest_result(void)
{
...
#if APP_VITAL_SIGNS_ENABLE_BRIEF_OUTPUT
    {
        ...
        (void)BoardOutput_printf("vital_brief,f=%lu,vote=%u/%u,src=%s,slow=%lu,ok=%u/%u,br=%u.%u,hr=%u.%u,br256=%u.%u,hr256=%u.%u\r\n",
