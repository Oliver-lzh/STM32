# 更新内部启动采集调试入口中文技能文档，说明如何通过 BGT60TR13C 寄存器配置雷达并启动采集拿到 payload 数据
...
## Evidence Inputs
- Source task: 更新内部启动采集调试入口中文技能文档，说明如何通过 BGT60TR13C 寄存器配置雷达并启动采集拿到 payload 数据
- Intent contract: intent-contract.json
- Runtime input packet: runtime-input-packet.json

## Runtime Input Truth
- Governance scope: root
- Root run id: 20260512T005457Z-9334c1ba
- Entry intent: vibe
...
- Capsule [2b83c2ed43bbc24d] Cognee relation: radarbaseboardmcu7-1-board-datacallback-dataavian-payload-count specified_by 2026-05-11-radarbaseboardmcu7-1-board-datacall...
  ...
  Expansion Ref: C:\Users\Oliver\Desktop\in\firmware-rbb7\firmware-rbb7\Firmware\outputs\runtime\vibe-sessions\20260512T005457Z-9334c1ba\memory-backend\cognee-read-response.json#2b83c2ed43bbc24d
