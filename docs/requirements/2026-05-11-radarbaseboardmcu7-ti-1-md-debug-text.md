...
## Evidence Inputs
- Source task: RadarBaseboardMCU7 TI生命体征移植 阶段1数据入口探测 中文md文档 参考雷达输出模式切换开发技能 回答DEBUG_TEXT串口打印雷达信息可行性 不改源码
- Intent contract: intent-contract.json
- Runtime input packet: runtime-input-packet.json

## Runtime Input Truth
- Governance scope: root
- Root run id: 20260511T084442Z-f4cbd214
- Entry intent: vibe
...
- Capsule [7c666af60071587c] Cognee relation: fix-vs-code-c-c-include-resolution-errors-in-radarbaseboardmcu7 specified_by 2026-05-08-fix-vs-code-c-c-include-resolution-...
  ...
  Expansion Ref: C:\Users\Oliver\Desktop\in\firmware-rbb7\firmware-rbb7\Firmware\outputs\runtime\vibe-sessions\20260511T084442Z-f4cbd214\memory-backend\cognee-read-response.json#7c666af60071587c
